...
public class Fish {
	...
	/*
	 * This fish eats the other fish. I.e. This fish's size is increased by the size
	 * of the fish "other". The size of "other" is set to 0.
	 */
	...
	public String toString() {
		String compile = "Fish, size" + size + "(" + row + ", " + col + ") is facing: " + direction;
		return compile;
	}
