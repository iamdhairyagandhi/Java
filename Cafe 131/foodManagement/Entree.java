...
public class Entree implements Listable {
	/*
	 * STUDENTS: You may NOT add any other instance variables or static variables!
	 */
	private String name;
	private SortedListOfImmutables foodList; // This list will contain Food objects

	/**
	 * Standard constructor. To ensure that the Entree class remains immutable, this
	 * constructor will make a copy of the list that foodListIn refers to. (This is
	 * necessary because a SortedListOfImmutables is mutable.)
	 * 
	...
	/**
	 * Compares the current object to the parameter and returns true if they have
	 * the same name.
	 * 
	...
	/*
	 * We'll give you this one for free. Do not modify this method or you will fail
	 * our tests!
	 */
